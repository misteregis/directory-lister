...
var $W = $(window),
  ...
  DEFAULTS = {
    ...
    headerToolbar: ['open_img', 'maximize', 'close'],
    ...
    icons: {
      open_img: '<svg viewBox="0 0 24 28" class="svg-inline-icon">\
...
Magnify.prototype = {
  ...
  _createBtns: function (toolbar) {
    ...
    var btns = [
      'open_img', 'minimize', 'maximize', 'close',
  ...
  build: function () {
    ...
    this.$open_img = $magnify.find('.magnify-button-open_img');
  ...
  _addEvents: function () {
    ...
    this.$open_img.off(CLICK_EVENT + EVENT_NS).on(CLICK_EVENT + EVENT_NS, function () {
      self.open_img();
    });
