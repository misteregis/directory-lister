...
var $W = $(window),
  ...
  DEFAULTS = {
    ...
    icons: {
      open: '<svg viewBox="0 0 24 28" class="svg-inline-icon" style="enable-background:new 0 0 24 28;">\
                <path fill="currentColor" d="M20,14.5V7c0-0.5-0.5-1-1-1h-7.5c\
                -0.4,0-0.8,0.2-0.9,0.6c-0.2,0.4-0.1,0.8,0.2,1.1L13,10l-8.3,8.3c\
                -0.4,0.4-0.4,1,0,1.4 l1.6,1.6c0.4,0.4,1,0.4,1.4,0L16,13l2.2,\
                2.2c0.2,0.2,0.4,0.3,0.7,0.3c0.1,0,0.3,0,0.4-0.1C19.8,15.3,20,\
                14.9,20,14.5z M24,6.5v15	c0,2.5-2,4.5-4.5,4.5h-15C2,26,0,24,\
                0,21.5v-15C0,4,2,2,4.5,2h15C22,2,24,4,24,6.5z"/></path>\
                </svg>',
    ...
    i18n: {
      ...
      actualSize: 'Tamanho real (Ctrl+Alt+0)',
      rotateLeft: 'Girar para esquerda (Ctrl+,)',
      rotateRight: 'Girar para direita (Ctrl+.)'
    },
...
Magnify.prototype = {
  ...
  render: function () {
    ...
    var btnsTpl = {
      open: '<button class="magnify-button magnify-button-open" title="' +
        this.options.i18n.open + '">' +
        this.options.icons.open +
        '</button>',
  ...
  build: function () {
    ...
    this.$open = $magnify.find('.magnify-button-open');
  ...
  openImg: function(){
    window.open(this.groupData[this.groupIndex].src)
    this.close()
  },
  maximize: function () {
  ...
  addEvents: function () {
    ...
    this.$open.off(CLICK_EVENT + EVENT_NS).on(CLICK_EVENT + EVENT_NS, function () {
      self.openImg();
    });
